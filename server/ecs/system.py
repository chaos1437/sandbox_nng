...
class System(ABC):
    ...
    def on_before_move(self, world: "World", player_id: str, dx: int, dy: int) -> bool:
        """Called before a player moves.

        Args:
            world: The game world (GameWorld instance).
    ...
    def on_after_move(self, world: "World", player_id: str, dx: int, dy: int) -> None:
    ...
    def on_player_leave(self, world: "World", player_id: str) -> None:
